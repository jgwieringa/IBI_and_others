...
files1 <- list.files(path = "./Environmental Layers/Marspec_cropped_present",pattern = '.grd$', full.names = TRUE)
pred=stack(files1[1],files1[2],files1[3],files1[4],files1[5],files1[6],files1[7],files1[8],files1[9],files1[10],files1[11])

names(pred)=c("bath","mar01","mar02","mar03","mar04","mar05","mar06","mar07","mar08","mar11","mar16")

files2=list.files(path = "./Environmental Layers/Marspec_LGM_cropped",pattern = '.grd$', full.names = TRUE)
...
lgm=stack(files2[1],files2[2],files2[3],files2[4],files2[5],files2[6],files2[7],files2[8],files2[9],files2[10],files2[11])
names(lgm)=c("bath","mar01","mar02","mar03","mar04","mar05","mar06","mar07","mar08","mar11","mar16")

ext=extent(lgm)

files <- list.files(,path="./Reduced_species_occurrences/Marine",pattern = '.csv$', full.names = TRUE)
...
for(i in 1:length(files)){
  ...
  model=factor(pa)~bath+mar01+mar02+mar03+mar04+mar05+mar06+mar07+mar08+mar11+mar16
  ...
  glm1=glm(pa~bath+mar01+mar02+mar03+mar04+mar05+mar06+mar07+mar08+mar11+mar16, data = envtrain)
